...
import {desc,price,image} from "./holidaydetails"
// import {KeyboardArrowDown} from '@mui/icons-material';
export function Holidaycheckout() {
  return (
    <div>
      <div id="mainCDiv">
      ...
      <div id="brandCheckout" >
            <div>
                <img id = "check67"src={brandlogo} alt="brandlogo" height="30px" width="80px"/>
            </div>
          ...
          <div id="divC1">
              <div>
                  ...
                  <div id="flageflex">
                      <img id = "look" src="https://p.kindpng.com/picc/s/192-1929235_indian-flag-button-india-flag-button-png-transparent.png" alt="" width='25px' height='25px'/>
                      <div>India</div>
                  </div>
              </div>
              <div>
          ...
          <div id="divC7">
              ...
              <a href = "/done"><button id="placeorder">PLACE ORDER</button></a>
